...
CREATE TABLE "Expense" (
    ...
    "groupId" TEXT NOT NULL,
    "paidById" TEXT,
    "isComplexPayment" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "Expense" ADD CONSTRAINT "Expense_paidById_fkey" FOREIGN KEY ("paidById") REFERENCES "GroupMember"("id") ON DELETE SET NULL ON UPDATE CASCADE;
